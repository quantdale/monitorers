# Repository-Local Add-ons Master Plan — monitorers

## Status

**PLANNING ONLY / IMPLEMENT IN A LATER SESSION**

Target repository: `quantdale/monitorers`  
Planning branch: `plan/repo-local-addons-2026-08-28`

## Repository assessment

Active Windows Tauri 2 application: React/TypeScript/Vite frontend plus Rust backend using WMI, Win32 performance APIs, NVAPI/NVML, with Vitest/Playwright verification.

**Decision:** `RECOMMEND_SMALL_DOCS_FIRST_STACK`

Do not replace the existing simulation/E2E verification pipeline. These integrations are developer knowledge surfaces only.
...
**Why it fits:** High-value, docs-only access to current Win32/.NET/Windows platform documentation for WMI, performance counters and Windows APIs.

**Constraints:** Remote docs-only endpoint; no authentication or machine-control authority. Register only in repository scope.

### 2. Context7 MCP — RECOMMEND

**Type:** MCP

**Why it fits:** Version-aware documentation for Tauri, React, TypeScript, Vite and Rust-adjacent libraries during implementation work.

**Constraints:** Documentation assistance only; repository code/tests outrank retrieved docs.

## Explicitly not recommended

- A second Playwright MCP runtime—the repo already owns Playwright E2E
- Generic Windows-control MCPs with machine-wide authority
- Global Cargo/npm installs solely for agent integration
