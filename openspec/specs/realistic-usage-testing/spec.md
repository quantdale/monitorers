...
#### Scenario: Only the removed card disappears when several share a metric category
...
#### Scenario: Manual verification — 1-hour window tracks real elapsed time during a live session
